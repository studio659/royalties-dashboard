...
export function parseWarner(text, eurRate = 0.92) {
  ...
  for (let i = 1; i < lines.length; i++) {
    ...
    // ⚠️ NE PAS filtrer les négatifs : Warner reporte des corrections et remboursements
    // en montants/quantités négatifs. Les ignorer fausse le total Net du statement
    // (l'app affiche +X% de trop par rapport au "Total Redevances" Warner).
